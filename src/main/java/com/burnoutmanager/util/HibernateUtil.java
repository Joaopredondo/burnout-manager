    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:h2:mem:burnoutdb;DB_CLOSE_DELAY=-1");
                ...
                configuration.addAnnotatedClass(AvaliacaoBurnout.class);
                configuration.addAnnotatedClass(Recomendacao.class);
